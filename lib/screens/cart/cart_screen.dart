                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        ...
                                        ...group.items
                                          ...
                                          final index = cartGroups
                                                  .take(groupIndex)
                                                  .map((e) => e.items.length)
                                                  .sum +
                                              itemIndex;
                                          controller.totalItemControllers[index]
                                                    ...
                                                    children: [
                                                      SizedBox(
                                                        ...
                                                        child: Checkbox(
                                                          value: item.checkout,
                                                          onChanged: (value) =>
                                                              controller.onItemCheckedChange(
                                                                  checked:
                                                                      value ==
                                                                          true,
                                                                  cartItem:
                                                        ...
                                                        child: Column(
                                                          ...
                                                          mainAxisAlignment:
                                                              MainAxisAlignment
                                                                  .spaceBetween,
                                                          children: [
                                                            if (item.garansiPrice !=
                                                                    null &&
                                                                item.garansiPrice! >
                                                                    0)
                                                              InkWell(
                                                                onTap: () {
                                                                  controller.onGaransiItemCheckedChange(
                                                                      checked: !(item
                                                                              .garansiChecked ==
                                                                          true),
                                                                      cartItem:
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    SizedBox(
                                                                      ...
                                                                      child:
                                                                          Checkbox(
                                                                        value: item.garansiChecked ==
                                                                            true,
                                                                        onChanged: (checked) => controller.onGaransiItemCheckedChange(
                                                                            checked: checked ==
                                                                                true,
                                                                            cartItem:
                                                                                item,
                                                                            cartGroup:
                                                                                group), //controller.warrantyChecked.value = checked == true
                                                                      ),
                                                                    ),
                                                                    ...
                                                                    Text(" + ",
                                                                        style: TextStyle(
                                                                            ...
                                                                            color: item.stock == false
                                                                                ...
                                                                                : null)),
                                                                    Text(
                                                                        "Rp${NumberFormat('#,###').format(item.garansiPrice)}",
                                                                        style: TextStyle(
                                                                            fontSize:
                                                                                12,
                                                                            color: item.stock == false
                                                              ...
                                                              children: [
                                                                ...
                                                                SizedBox(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    controller:
                                                                        controller
                                                                            .totalItemControllers[index],
                                                                    onChanged:
                                                                        (value) {
                                                                      if (value ==
                                                                          '')
                                                                        return;
                                                                      controller.onChangeItemQuantity(
                                                                          quantity: int.parse(
                                                                              value),
                                                                          cartItem:
                                                                              item,
                                ...
                                child: Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Builder(
                                          builder: (context) {
                                            final productNoOfColumn = sizer
                                                        .Device.screenType ==
                                                    sizer.ScreenType.tablet
                                                ? (sizer.Device.safeWidth / 200)
                                                    .ceil()
                                                : 2;
                                            return Column(
                                              children: [
                                                        ...
                                                        builder: (context) {
                                                          ...
                                                          for (var col = 0;
                                                            ...
                                                            if (controller
                                                                    .recommendedProducts
                                                                    .length >
                                                                row * productNoOfColumn +
                                                                    col) {
                                                              rowWidget.children.add(Expanded(
                                                ...
                                                const Text("Promo Terpakai",
                                                    style: TextStyle(
                                                        ...
                                                        color:
                                                            Color(0xFF333333))),
                                                Text(
                                                    "${controller.couponUsed.value?.code}",
                                                    style: const TextStyle(
                                                        fontSize: 20,
                                                        color:
                                                            Color(0xFF0060AF),
                                                                            ...
                                                                            Column(
                                                                              children: [
                                                                                Container(
                                                                                  ...
                                                                                  child: Column(
                                                                                    children: [
                                                                                      if (controller.garansiUFOPro.value != null && int.tryParse(controller.garansiUFOPro.value!) != null && int.parse(controller.garansiUFOPro.value!) > 50000)
                                                                                        Column(
                                                                                          children: [
                                                                                            Row(
                                                                                  ...
                                                                                  Padding(
                                                                                    ...
                                                                                    child: Row(
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        const Text(
                                                                                          "UFO Poin",
                                                                                          style: TextStyle(fontFamily: 'MYRIADPRO', fontSize: 12, fontWeight: FontWeight.bold, color: AppColor.primaryColor),
                                                                                        ),
                                                                                        const SizedBox(width: 4),
                                                                                        Text(
                                                                                          controller.ufoPoin.value ?? "",
                                                                                          style: const TextStyle(fontFamily: 'MYRIADPRO', fontSize: 12, color: Color(0xFF636363)),
                                                                                        )
                                                                                      ],
                                                                                    ),
                                                                                  ),
