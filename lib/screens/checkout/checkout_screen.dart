        ...
        builder: (context) {
          return ModalBottomSheetDefault(
            ...
            child: (scrollController) => controller.obx((state) {
              ...
              bool clickAndCollectShippingMethodSelected =
                  controller.clickAndCollectShippingMethodSelected.value;
              DateTime? selectedPickupDate =
                  controller.clickAndCollectPickupDate.value;
              ShippingMethod? selectedShippingMethod =
                  controller.selectedShippingMethod.value;
              final kurirTokoShippingMethod =
                  controller.kurirTokoShippingMethod.value;
              return Column(
                children: [
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: StatefulBuilder(builder: (context, setState) {
                        void selectDelivery(
                          ...
                          setState(() {
                            clickAndCollectShippingMethodSelected =
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                ...
                                if (!clickAndCollectCollapsed &&
                                    checkout.optLoc?.isNotEmpty == true)
                                  InkWell(
                                    onTap: () {
                                ...
                                if (!clickAndCollectCollapsed &&
                                    checkout.optLoc?.isEmpty == true)
                                  Row(
                                    children: [
                                      const SizedBox(width: 15),
                                      Image.asset("assets/icon/ufomen_sad.webp",
                                          width: 60),
                                      const SizedBox(width: 8),
                                      const Expanded(
                                        child: Text(
                                            "Maaf, produk yang kamu beli tidak mendukung pengiriman \"Click & Collect\""),
                                      ),
                                      const SizedBox(
                                        width: 15,
                                      )
                                          ...
                                          Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                    "Rp ${thousandFormat.format(shippingMethod.cost)}",
                                                    style: const TextStyle(
                                                        fontSize: 13,
                                                        fontWeight:
                                                            FontWeight.bold,
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      border: Border.all(
                                          color: addressEntry.value.addressId ==
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          ...
                                          IconButton(
                                              onPressed: () {
                                                Navigator.pop(context);
                                                Get.toNamed(
                                                    AddressAddUpdateScreen
                                                        .routeName,
                                                    parameters: {
                                                      "id": addressEntry.value
                                                              .addressId ??
                                                          ""
                                                    });
                                              },
                                      ...
                                      Text(addressEntry.value.address2 ?? "",
                                          style: const TextStyle(
                                              fontWeight: FontWeight.bold,
                                              fontSize: 13)),
                                      Text(addressEntry.value.detail,
                      ...
                      child: Column(
                        children: [
                          SizedBox(
                            ...
                            child: FilledButton(
                              onPressed: () {
                                controller.previouslyAddressBottomSheetShown
                                    .value = false;
                                controller.selectedAddress.value =
                                    selectedAddress;
                                Get.showOverlay(
                                    asyncFunction: () => controller.load(
                          ...
                          Expanded(
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                final paymentGroup =
                                    controller.paymentMethodGroups[index];
                                return Column(
                                  children: [
                                    InkWell(
                                      onTap: () {
                                        setState(() {
                                          final open = paymentMethodOpens[
                                                  paymentGroup] ??
                                              false;
                                          paymentMethodOpens[paymentGroup] =
                                              !open;
                                        });
                                      },
                                      child: Column(
                                    ...
                                    if (paymentMethodOpens[paymentGroup] ==
                                        true)
                                      for (var paymentMethod
                                          in paymentGroup.methods)
                                        InkWell(
                                          onTap: () {
                                            setState(() {
      ...
      child: VisibilityDetector(
        ...
        child: Scaffold(
          ...
          appBar: const UEAppBar(
              title: 'Checkout', showCart: false, showNotification: false),
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                                "Store: ${checkout.stores.firstOrNull?.name ?? "-"}",
                                                style: const TextStyle(
                                                    fontSize: 10)),
                                            ...(product.option
                                                .map((e) => Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Center(
                                        child: TextButton(
                                            onPressed: () {
                                              Get.toNamed(AddressAddUpdateScreen
                                                  .routeName);
                                            },
                                            child: const Text(
                                                "Tambah Alamat Lain",
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                                          ...
                                          Text(
                                              controller.selectedShippingMethod
                                                  ...
                                                  controller
                                                      ...
                                                      .value
                                                      ?.headTitle ??
                                                  (controller.clickAndCollectShippingMethodSelected
                                                              .value ==
                                                          true
                                                      ? "Click & Collect"
                                        ...
                                        children: [
                                          Text(
                                              controller.selectedShippingMethod
                                                          .value !=
                                                      null
                                                  ? "(Rp.${controller.selectedShippingMethod.value?.cost.toString() ?? 0})"
                                                  : "",
                                              style: const TextStyle(
                                                  fontSize: 13,
                                                  color: AppColor.primaryColor,
                              ...
                              if (checkout.packingKayuChecked?.isNotEmpty ==
                                  true)
                                InkWell(
                                  onTap: () {
                                    controller.isPackingKayuChecked.value =
                                        !controller.isPackingKayuChecked.value;
                                  },
                                  child: Container(
                                    color: Colors.white,
                                    ...
                                    child: Row(
                                      children: [
                                        Checkbox(
                                            value: controller
                                                .isPackingKayuChecked.value,
                                            onChanged: (value) {
                                              controller.isPackingKayuChecked
                                                  .value = value == true;
                                            }),
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color:
                                          controller.paymentMethodError.value !=
                                                  null
                                              ? const Color(0xFFFFE1E1)
                                              : AppColor.primaryColor,
                                      border: controller
                                  ...
                                  child: Row(
                                    children: [
                                      if (controller.paymentMethodError.value !=
                                          null)
                                        Row(
                                          children: [
                                            Image.asset(
                                      ...
                                      Icon(
                                        Icons.arrow_right,
                                        color: controller.shippingMethodError
                                                    .value !=
                                                null
                                            ? AppColor.primaryColor
                                            : const Color(0xFFFBAA1A),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      Column(
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Text(
                                                  checkout.couponPrice?.title ??
                                                      ""),
                                              Text(
                                                  'Rp ${thousandFormat.format(checkout.couponPrice?.value ?? 0)}'),
                                            ],
                                          ),
                                          const SizedBox(height: 10)
                                        ],
                                      ),
                                    if (controller.garansiPrice.value != 0.0) ...[
                                      Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceBetween,
                                        children: [
                                          ...
                                          Text(
                                              'Rp ${thousandFormat.format(controller.garansiPrice.value)}'),
                                        ],
                                      ),
                                      const SizedBox(height: 10),
                                    ],
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                            'Pengiriman (${checkout.totalWeight} KG)'),
                                        if (controller
                                                .clickAndCollectShippingMethodSelected
                                                .value ==
                                            true)
                                          Text(
                                              'Rp ${thousandFormat.format(controller.selectedShippingMethod.value?.cost ?? 0)}'),
                                        if (controller
                                                .clickAndCollectShippingMethodSelected
                                                .value !=
                                            true)
                                    ...
                                    if (checkout.packingKayuChecked
                                                ?.isNotEmpty ==
                                            true &&
                                        controller.isPackingKayuChecked.value)
                                      Column(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            'Rp ${thousandFormat.format(checkout.biayaLayanan)}'),
                                      ],
                                    ),
                                    const SizedBox(height: 10),
                                    const Divider(),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            Image.asset(
                                                "assets/icon/account/ufo-point.webp",
                                                width: 20),
                                            const SizedBox(width: 4),
                                            Text(
                                                'UFO Poin : ${thousandFormat.format(checkout.totalAllUfoP)}')
                                          ],
                                        ),
                                      ],
                                    ),
                  ...
                  child: Row(
                    ...
                    children: [
                      if (checkout.useCoupon.isEmpty)
                        const Text("Belum ada voucher yang terpakai",
                            style: TextStyle(fontSize: 13))
                      else
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text("Promo Terpakai",
                                style: TextStyle(
                                  ...
                                  return ModalBottomSheetDefault(
                                    ...
                                    child: (scrollController) {
                                      return VoucherScreen(
                                        ...
                                        prevSelectedVoucher:
                                            checkout.useCoupon.firstOrNull,
