...
class BestSellerController extends StateController<SuperDealResponse> {
  final HomeRepository _repository;
  BestSellerController({required HomeRepository repository}): _repository = repository;
  @override
  void onInit() {
    super.onInit();
    futurize(_repository.loadBestSeller);
  }
}